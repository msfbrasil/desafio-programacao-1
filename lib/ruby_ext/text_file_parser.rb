...
class TextFileParser
  ...
  # +row_callback_method+:: method to be called with the values of each file detected row on a Array.
  ...
  #
  def initialize( parsing_file, original_file_name, field_separator, header_lines_qtty, row_callback_method, save_copy, save_copy_base_path )
    
    @parsing_file = parsing_file
    @original_file_name = original_file_name
    @field_separator = field_separator
    @header_lines_qtty = header_lines_qtty
    @row_callback_method = row_callback_method
    @save_copy = save_copy
    ...
    #puts 'row_callback_method = ' + @row_callback_method.to_s
